...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  String _favoriteProduct = "Aún no hay pedidos";
  ...
  Future<void> _analyzeUserData() async {
    ...
    if (productCounts.isNotEmpty) {
      var sortedKeys = productCounts.keys.toList(growable: false)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(
        0xFFF4F6F8,
      ), // Fondo gris ultra claro para que resalten las tarjetas
      appBar: AppBar(
        backgroundColor: Colors.transparent,
        elevation: 0,
        centerTitle: true,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            // --- 1. AVATAR MODERNO (Con efecto Glow) ---
            Container(
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                boxShadow: [
            ...
            // --- 2. TARJETA DE FIDELIZACIÓN (Zampa Rewards) ---
            Container(
              width: double.infinity,
            ...
            // --- 3. ESTADÍSTICAS EN TARJETAS LIMPIAS ---
            Row(
              children: [
                _buildStatCard(
                  "Pedidos",
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.black, // Contraste fuerte y moderno
                  elevation: 5,
  ...
  Widget _buildStatCard(String title, String value, IconData icon) {
    return Expanded(
      child: Container(
        ...
        child: Column(
          crossAxisAlignment:
              CrossAxisAlignment.start, // Alineado a la izquierda, más moderno
          children: [
